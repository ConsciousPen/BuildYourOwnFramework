...
public class BrowserController {
    ...
    private static final Logger logger = LoggerFactory.getLogger(BrowserController.class.getSimpleName());
    ...
    public static WebDriver getDriver() {
        ...
        String browser = properties.getProperty(BROWSER, CHROME.browserName());
    ...
    private static  WebDriverListener getWebDriverListener() {
        return new WebDriverListener() {
            @Override
            public void onError(Object target, Method method, Object[] args, InvocationTargetException e) {
                File tempFile = ((TakesScreenshot) getDriver()).getScreenshotAs(OutputType.FILE);
                try {
